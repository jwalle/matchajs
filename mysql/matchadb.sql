...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 23, 2019 at 12:13 PM
...
-- Database: `matchadb`
--
CREATE DATABASE IF NOT EXISTS `matchadb` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `matchadb`;
...
--
ALTER TABLE `users_relations`
  MODIFY `RelationID` bigint(20) NOT NULL AUTO_INCREMENT;
--
